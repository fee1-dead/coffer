...
/// Helper structure for reading a indirect string. This represents the name of a module.
#[repr(transparent)]
#[derive(Clone, Eq, PartialEq, Debug, ConstantPoolReadWrite)]
pub struct To(#[str_type(Module)] pub Cow<'static, str>);

/// Helper structure for reading a indirect string. This represents the name of a class.
#[repr(transparent)]
#[derive(Clone, Eq, PartialEq, Debug, ConstantPoolReadWrite)]
