...
pub fn modified_utf8_to_string(buf: &[u8]) -> Result<Cow<[u8]>, MUTFError> {
    ...
    if borrow {
        ...
        str.shrink_to_fit();
        Ok(Cow::Owned(str.into_bytes()))
    }
}

pub fn string_to_modified_utf8(str: &str) -> Cow<[u8]> {
